export abstract class TagConstants {
  ...
  /**
   * End of abc directive. See https://www.chordpro.org/chordpro/directives-env_abc/
   */
  static readonly END_OF_ABC = "end_of_abc";
  ...
  /**
   * Start of abc directive. See https://www.chordpro.org/chordpro/directives-env_abc/
   */
  static readonly START_OF_ABC = "start_of_abc";
